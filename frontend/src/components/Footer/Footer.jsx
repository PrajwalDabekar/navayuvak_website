...
export default function Footer() {
    return (
        <footer className="bg-[#080e3f] border-y">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-slate-50	 uppercase">Resources</h2>
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-slate-50	 uppercase">Follow us</h2>
                            <ul className="text-slate-300 font-medium">
                                <li className="mb-4">
                                    <a
                                        href="https://www.instagram.com/navayuvak_entrepreneurs?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                                ...
                                <li>
                                    <Link to="https://www.linkedin.com/in/gaurav-mishra-81188152/?originalSubdomain=in" className="hover:underline">
                                        LinkedIn
                                    </Link>
                                </li>
                            </ul>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-slate-300 sm:text-center">
                        ...
                        <a href="#" className="hover:underline">
                            Navayuvak Entrepreneurs
                        </a>
                        . All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                        <Link to="#" className="text-slate-50 hover:text-slate-400">
                            <svg
                                className="w-4 h-4"
                                aria-hidden="true"
                        ...
                        <Link to="https://www.instagram.com/navayuvak_entrepreneurs?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" 
                        className="text-slate-50 hover:text-slate-400">
                            <svg
                                ...
                                viewBox="0 0 20 20"
                            >
                                <path d="M11 0H5a5 5 0 0 0-5 5v6a5 5 0 0 0 5 5h6a5 5 0 0 0 5-5V5a5 5 0 0 0-5-5zm3.5 11c0 1.93-1.57 3.5-3.5 3.5H5c-1.93 0-3.5-1.57-3.5-3.5V5c0-1.93 1.57-3.5 3.5-3.5h6c1.93 0 3.5 1.57 3.5 3.5v6z"></path><path d="M8 4a4 4 0 1 0 0 8 4 4 0 0 0 0-8zm0 6.5A2.503 2.503 0 0 1 5.5 8c0-1.379 1.122-2.5 2.5-2.5s2.5 1.121 2.5 2.5c0 1.378-1.122 2.5-2.5 2.5z"></path><circle cx="12.3" cy="3.7" r=".533"></circle>
                            </svg>
                            <span className="sr-only">Instagram Account</span>
                        </Link>
                        <Link to="https://www.linkedin.com/in/gaurav-mishra-81188152/?originalSubdomain=in" className="text-slate-50 hover:text-slate-400">
                            <svg
                                className="w-4 h-4"
                                aria-hidden="true"
